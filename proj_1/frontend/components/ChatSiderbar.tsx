...
const ChatSiderbar = ({
    sidebarOpen, showAllUsers, setShowAllUsers, setSiderbarOpen,
    users, loggedInUser, chats,
    selectedUser, setSelectedUser, handleLogout, createChat
}: ChatSiderbarProps) => {
    ...
    return (
        <aside className={`fixed z-20 sm:static top-0 left-0 h-screen w-80 bg-gray-900 border-r border-gray-700 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
                        ...
                        <div className='space-y-4 flex flex-col flex-1 min-h-0'>
                            <div className='relative shrink-0'>
                                ...
                                <input
                                    ...
                                    className='w-full pl-10 pr-4 py-3 bg-gray-800 border border-gray-700 text-white placeholder-gray-400 rounded'
                                    value={searchQuery}
                                            ...
                                            <div className='flex items-center gap-3'>
                                                ...
                                                <div className='flex-1 min-w-0'>
                                                    <div className='flex items-center justify-between mb-1'>
                                                        ...
                                                        {
                                                            unseenCount > 0 && <div className='bg-red-600 text-white text-xs font-bold rounded-full min-w-[22px] h-5.5 flex items-center justify-center px-2'>
            ...
            <div className='p-4 border-t border-gray-700 space-y-2'>
                <Link href={'/profile'} className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-800 transition-colors text-white">
                    <UserCircle className='w-6 h-6 text-gray-300' />
            ...
            <button
                ...
                className='w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-red-600 trasition-colors text-red-500 hover:text-white'>
